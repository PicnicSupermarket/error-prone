...
/** {@link UnwrapUnnecessaryExpressionsTest}Test */
@RunWith(JUnit4.class)
public class UnwrapUnnecessaryExpressionsTest {
  private final BugCheckerRefactoringTestHelper helper =
      BugCheckerRefactoringTestHelper.newInstance(UnwrapUnnecessaryExpressions.class, getClass());
  ...
  @Test
  public void nestedTypeInLambda() {
    helper
        .addInputLines(
            "Foo.java",
        ...
        .addOutputLines(
            ...
            "public final class Foo {",
            "  public Flux<Integer> test() {",
            "    return Flux.just(1, 2).flatMap(i -> Flux.just(i));",
            "  }",
            "}")
        .doTest();
  }
